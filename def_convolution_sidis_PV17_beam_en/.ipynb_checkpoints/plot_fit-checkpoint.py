...
fig.savefig('fit_grid_plot/Lb_pi_p_partial_'+ str(coef)+'_chi_'+str(chi)+'.pdf')
fig1.savefig('fit_grid_plot/Lb_k_p_partial_'+ str(coef)+'_chi_'+str(chi)+'.pdf')
fig2.savefig('fit_grid_plot/Lb_pi_m_partial_'+ str(coef)+'_chi_'+str(chi)+'.pdf')
fig3.savefig('fit_grid_plot/Lb_k_m_partial_'+ str(coef)+'_chi_'+str(chi)+'.pdf')
