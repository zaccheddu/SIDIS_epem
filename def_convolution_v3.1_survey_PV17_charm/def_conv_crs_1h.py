...
class polarization_1h :
	...
	def denominator(self,had1,z1,pt):
		...
		def fnc(btt):
			...
			elif self.g_k == 'blny':res = res*scl.analytic_sudakov_1h(btt)*scl.g_K_blny_1h(btt,z1)			
			...
			#
			###
			elif self.g_k == 'new_lgm': res = res*scl.analytic_sudakov_1h(btt)*scl.g_K_new_1h_lgm(btt,z1)
			elif self.g_k == 'll_lgm': res = res*scl.analytic_sudakov_1h(btt)*scl.g_K_ll_1h_lgm(btt,z1)
			elif self.g_k == 'exp_lgm': res = res*scl.analytic_sudakov_1h(btt)*scl.g_K_exp_1h_lgm(btt,z1)

			### PV17
			elif self.g_k == 'PV17': res = res*scl.analytic_sudakov_1h(btt)*scl.g_K_bac_1h_lgm(btt,z1)
